...
export SOCKS_USER=${SOCKS_USER:-'NbVZtxD4'}
export SOCKS_PASS=${SOCKS_PASS:-'67OkT2E2'}
...
sleep 1
yellow "注意：v2ray或其他软件的跳过证书验证需设置为true,否则tuic节点可能不通\n"
cat > list.txt <<EOF
...
purple "Running done!"
yellow "Serv00|ct8老王sing-box一键四协议安装脚本（NeoMan修改版）(vmess-ws|vmess-ws-tls(argo)|socks5|tuic)\n"
